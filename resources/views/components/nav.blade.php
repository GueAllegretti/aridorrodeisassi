  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link {{(Route::currentRouteName() == 'casa') ? 'active nav-color-active' : ''}}" href="{{route('casa')}}">{{__('generico.struttura')}}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{(Route::currentRouteName() == 'escursioni') ? 'active nav-color-active' : ''}}" href="{{route('escursioni')}}">{{__('generico.escursioni')}}</a>
        </li>
        <li class="nav-item">
